...
@Component({
  selector: 'app-music-online',
  templateUrl: './music-online.page.html',
  styleUrls: ['./music-online.page.scss'],
})
export class MusicOnlinePage implements OnInit, OnDestroy {
  ...
  goToDeezer() {
    this.iab.create(this.data.link, `_system`);
  }
  ...
  prepareAudioFile() {
    this.platform.ready().then(() => {
      ...
      // })
      this.playTheTrack = this.data.preview;
      this.image = this.data.album.cover_big;
      console.log(this.data.album.cover);
      // this.image = './assets/image/music.jpg';
